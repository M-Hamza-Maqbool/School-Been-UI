...
function SideBar() {
    return (
        <div className="h-screen flex flex-no-wrap ">

            {/* Sidebar starts */}
            {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
            <div className="w-64 absolute sm:relative bg-blue-900 shadow md:h-full text-white flex-col justify-between hidden sm:flex">
                <div className="px-8">
                    ...
                    {/* <div className="flex justify-center mt-48 mb-4 w-full">
                        <div className="relative ">
                            ...
                            <input className=" bg-white focus:outline-none rounded w-full text-sm text-gray-500 bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div> */}
                </div>
